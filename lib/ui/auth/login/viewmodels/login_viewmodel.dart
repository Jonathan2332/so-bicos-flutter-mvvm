...
class LoginViewModel {
  ...
  LoginViewModel({required this.authRepository, required this.appLocalizations});
  ...
  Future<void> loginEmail((String, String) credentials) async {
    viewState.value = AuthLoadingState();
    final (email, password) = credentials;
    final result = await authRepository.loginEmail(email, password);
    result.fold(
      (user) {
